...
def nested_easy(timestamp: int):
    # --- Configuration ---
    # Outer Cycle: 10 blocks (1 Block = 100000 sec)
    # Inner Split: 10 slots per block
    # Target: The last slot of the last block in a cycle
    
    # 1. Outer Plateau (The "Week" check)
    # Block Index = timestamp // 100000
    # Cycle Position = Block Index % 10
    # Target: 9 (Last day of the cycle)
    
    block_idx = timestamp // 100000
    cycle_pos = block_idx % 10
