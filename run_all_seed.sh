...
# # arg => hcc
# python test_benchmark_parallel_csv.py --output benchmark_log_1_biased_41 --seed 41
# python test_benchmark_parallel_csv.py --output benchmark_log_1_biased_42 --seed 42
# python test_benchmark_parallel_csv.py --output benchmark_log_1_biased_43 --seed 43
# python test_benchmark_parallel_csv.py --output benchmark_log_1_biased_44 --seed 44
# python test_benchmark_parallel_csv.py --output benchmark_log_1_biased_45 --seed 45
# 5 test
# add list to 5 elt

# # arg => hc
# python test_benchmark_base_parallel_csv.py --output benchmark_log_2_biased_41 --seed 41
# python test_benchmark_base_parallel_csv.py --output benchmark_log_2_biased_42 --seed 42
# ...
# 5 test
# add list to 5 elt
...
# # arg => ga
# python test_benchmark_ga_csv.py --output benchmark_log_ga_biased_41 --seed 41
# python test_benchmark_ga_csv.py --output benchmark_log_ga_biased_42 --seed 42
# ...
# 5 test
# add list to 5 elt
...
# under the list
# python coverage_generator.py elt in the list, extract the coverage info
# touch elt/test_config.json "total_execution_time_formatted": field and 
# right at the terminal

# arg 
# => hcc
# hcc 
# tot_time |  seed  | tot_coverage
# 4m 43s   |  41    | 3642% / 3800%

# => hc 
# hc
# total time seed  coverage
