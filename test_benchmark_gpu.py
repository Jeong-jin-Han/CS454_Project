"""
SEQUENTIAL version of branch testing.

⚠️  For PARALLEL execution (faster), see:
    - test_benchmark_gpu_parallel.py (full parallelization)
    - test_benchmark_gpu_parallel_v2.py (metadata sharing)
    - PARALLEL_README.md (documentation)
"""
